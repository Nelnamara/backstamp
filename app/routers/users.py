...
class UserUpdate(SQLModel):
    """Only email is editable here — everything else about an account is
    either auth-flow work or not designed yet. Setting email is what lets
    a pre-auth account (created via the old POST /users stopgap) start
